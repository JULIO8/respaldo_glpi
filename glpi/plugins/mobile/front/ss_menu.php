      ...
      //version check	                                                    								              								
		...
		if($headers[0] != '') {
			...
			if ($headers[0] == 'HTTP/1.0 404 Not Found') {
				$welcome = 'GLPI - Mobile &nbsp; <a href="https://forge.glpi-project.org/projects/mobile/files" target="_blank" style="color:#fff;">                
	           <span class="blink_me">'. __('New version avaliable').'</span></a>';		
					}				
			else {
					$welcome = "GLPI - Mobile";
					}		
